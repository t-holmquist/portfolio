  ...
  return (
    <div className="mt-20 lg:mt-40">
      <CardGradientSource className="flex flex-col gap-5 items-center rounded-[22px] max-w-sm md:max-w-lg p-4 sm:p-10 bg-brandBackgroundBlack">
        ...
        <p className="mb-8 sm:mb-0 text-sm text-neutral-600 dark:text-neutral-400 font-sourceSans">
        ...
        <div onMouseLeave={handleMouseLeave} onMouseEnter={handleMouseEnter} className="hidden rounded-md lg:flex pl-4 pr-1 py-1 text-white items-center space-x-1 bg-brandAccent hover:bg-[#7e66c7] text-xs font-bold">
          <span className="text-xs font-oswald">Get a proper greeting</span>
